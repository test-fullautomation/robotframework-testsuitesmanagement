...
Test Local Config With Input Variable 01
    ...
    Should Be Equal    ${gPreproString}    Preprocessor - Test local config updated!
    Should Be Equal    ${gGlobalString}    Local configuration test!
    Should Be Equal    ${testNewVar}    ${9.999}
    Should Be Equal    ${gGlobalStructure.local_config_add}    ${1901}