...
Test Case tsm-testfile-26-unicode_digits
   [documentation]    tsm-testfile-26-unicode_digits
   rf.extensions.pretty_print    ${CONFIG.Project}        PARAMS-VERIFIKATION : ({CONFIG.Project} / tsm-testfile-26-unicode_digits)
   rf.extensions.pretty_print    ${listvalue}            PARAMS-VERIFIKATION : ({listvalue} / tsm-testfile-26-unicode_digits)
