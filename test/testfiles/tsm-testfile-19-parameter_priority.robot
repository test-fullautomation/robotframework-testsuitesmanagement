...
Test Case tsm-testfile-19-parameter_priority
   ...
   Log    teststring_common : ${teststring_common} (tsm-testfile-19-parameter_priority.robot)      console=yes
   Log    teststring_variant : ${teststring_variant} (tsm-testfile-19-parameter_priority.robot)    console=yes
   Log    teststring_bench : ${teststring_bench} (tsm-testfile-19-parameter_priority.robot)        console=yes
