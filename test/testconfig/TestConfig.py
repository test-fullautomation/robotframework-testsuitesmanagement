...
# "tsm-testfile-1.robot"         # (without variant configuration)
# "tsm-testfile-2.robot"         # (with variant configuration)
# "tsm-testfile-3.robot"         # (with variant configuration and more parameters logged / composite datatypes from configuration files)
# "tsm-testfile-4-err-1.robot"   # (with variant configuration; JSON file contains syntax errors)
# "tsm-testfile-5-err-2.robot"   # (with variant configuration; JSON file contains not existing file and folder)
# "tsm-testfile-6-err-3.robot"   # (with variant configuration; missing "default" variant)
# "tsm-testfile-7-fail.robot"    # (with variant configuration; keyword FAIL)
# "tsm-testfile-8-unknown.robot" # (with variant configuration; keyword UNKNOWN)
...
dictUsecase['TESTFILENAME']     = "tsm-testfile-1.robot"
...
dictUsecase['SUBSECTION']       = "GOODCASE"
dictUsecase['COMMENT']          = "Single file execution"
dictUsecase['TESTFILENAME']     = "tsm-testfile-2.robot"
dictUsecase['TESTFOLDERNAME']   = None
dictUsecase['ADDITIONALPARAMS'] = None
dictUsecase['EXPECTEDRETURN']   = 0
listofdictUsecases.append(dictUsecase)
...
dictUsecase['SUBSECTION']       = "BADCASE"
dictUsecase['COMMENT']          = "Single file execution"
dictUsecase['TESTFILENAME']     = "tsm-testfile-4-err-1.robot" # (with variant configuration; JSON file contains syntax errors)
dictUsecase['TESTFOLDERNAME']   = None
dictUsecase['ADDITIONALPARAMS'] = None
dictUsecase['EXPECTEDRETURN']   = 256
listofdictUsecases.append(dictUsecase)
...
dictUsecase['SUBSECTION']       = "BADCASE"
dictUsecase['COMMENT']          = "Single file execution"
dictUsecase['TESTFILENAME']     = "tsm-testfile-5-err-2.robot" # (with variant configuration; JSON file contains not existing file and folder)
dictUsecase['TESTFOLDERNAME']   = None
dictUsecase['ADDITIONALPARAMS'] = None
dictUsecase['EXPECTEDRETURN']   = 256
listofdictUsecases.append(dictUsecase)
...
dictUsecase['SUBSECTION']       = "BADCASE"
dictUsecase['COMMENT']          = "Single file execution"
dictUsecase['TESTFILENAME']     = "tsm-testfile-6-err-3.robot" # (with variant configuration; missing "default" variant)
dictUsecase['TESTFOLDERNAME']   = None
dictUsecase['ADDITIONALPARAMS'] = None
dictUsecase['EXPECTEDRETURN']   = 256
listofdictUsecases.append(dictUsecase)
...
dictUsecase['SUBSECTION']       = "BADCASE"
dictUsecase['COMMENT']          = "Single file execution"
dictUsecase['TESTFILENAME']     = "tsm-testfile-1.robot" # (without variant configuration)
dictUsecase['TESTFOLDERNAME']   = None
...
dictUsecase['SUBSECTION']       = "BADCASE"
dictUsecase['COMMENT']          = "Single file execution"
dictUsecase['TESTFILENAME']     = "tsm-testfile-2.robot" # (with variant configuration)
dictUsecase['TESTFOLDERNAME']   = None
...
dictUsecase['SUBSECTION']       = "GOODCASE"
dictUsecase['COMMENT']          = "Single file execution"
dictUsecase['TESTFILENAME']     = "tsm-testfile-3.robot" # (with variant configuration and more parameters logged / composite datatypes from nested configuration files)
dictUsecase['TESTFOLDERNAME']   = None
dictUsecase['ADDITIONALPARAMS'] = f"--variable variant:\"nested_import\""
dictUsecase['EXPECTEDRETURN']   = 0
listofdictUsecases.append(dictUsecase)
del dictUsecase
# --------------------------------------------------------------------------------------------------------------
...
dictUsecase['SUBSECTION']       = "BADCASE"
dictUsecase['COMMENT']          = "Single file execution"
dictUsecase['TESTFILENAME']     = "tsm-testfile-7-fail.robot" # (with variant configuration; keyword FAIL)
dictUsecase['TESTFOLDERNAME']   = None
dictUsecase['ADDITIONALPARAMS'] = f"--variable variant:\"variant1\""
...
dictUsecase['SUBSECTION']       = "BADCASE"
dictUsecase['COMMENT']          = "Single file execution"
dictUsecase['TESTFILENAME']     = "tsm-testfile-8-unknown.robot" # (with variant configuration; keyword UNKNOWN)
dictUsecase['TESTFOLDERNAME']   = None
dictUsecase['ADDITIONALPARAMS'] = f"--variable variant:\"variant1\""
dictUsecase['EXPECTEDRETURN']   = 256
listofdictUsecases.append(dictUsecase)
