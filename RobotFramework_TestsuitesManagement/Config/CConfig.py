...
robot with configuration level 2.")
        ...
        if self.__tsm_app_config:
            ...
            self.sLoadedCfgLog['error'].append(self.__tsm_app_config_error)
            self.sLoadedCfgLog['unknown'] = "Execution will be aborted because of a critical version check issue!"
